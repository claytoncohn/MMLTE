...
% NEED CATEGORIES FOR LATEST ROUND OF FEATURE EXTRACTION:
...
\subsection{Analysis}
% Explain our analysis methods, i.e., which descriptive statistics we used, clusters for quantitative analysis, and subdomains for qualitative analysis.
% How successful were the methods/approaches? What was lacking? Overall, across all 73 works.
...
% Changed subsection from communities to clusters
\subsection{Clusters} % Eduardo
...
% Categorization and description of MMLA literature via clustering (quantitative)
% Also discuss implications, limitations, and future research directions with MMLA
% Address Need for mid fusion
% All analysis should address:
%   SOTA
%   Challenges
%   Results trends
%   Unimodal vs. multimodal advantages
% Tie qualitative findings to quantitative findings in some way
