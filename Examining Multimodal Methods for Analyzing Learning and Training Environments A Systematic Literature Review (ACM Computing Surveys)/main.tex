...
% List Modalities (didn't find any audio affect)
% PROS, TRANS, TEXT, SPECT
-PROS: 24\\
-TRANS: 16\\
-TEXT: 1\\
-SPECT: 1\\
...
Most analysis is done via qualitative analysis and statistical methods. Some is done classification, but not much with reg/patt/net. Contrast to full corpus, where classification was the most prevalent.
...
-Focus on statistical analysis and qualitative, but lacking in AI/ML
...
% SOTA
-Discuss RNNs, Transformers, other ML methods (SVM and RF) with limitation on explainability.

% For 12/6:
%   Analysis methods for previous 12 papers (put in notes)
%   Challenges/collab/analysis for remaining papers
%   Results analysis
%   SOTA
