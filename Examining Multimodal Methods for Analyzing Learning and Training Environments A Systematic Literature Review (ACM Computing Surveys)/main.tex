...
%   Lack of approaches that work across domains and are generalizable (reference multimodal/multi-task/multidomain AI like LLMs)
...
%   Reserach gap: lack of trust and explainability---especially with predictive methods. Quantitative approaches often involve opaque algorithms whose results are not easily explainable, which can lead to distrust by the end user. Qualitative methods provide explainability but are subject to human biases.
...
%   Initiall tried to search XAI
%   Codesign
%   Data viz (cite Nicole Hutchins dissertation tool, Caleb dissertation work, ChimeraPy)
...
% Textless NLP 
% Infrastructure/data viz (ChimeraPy IEEE cite)
