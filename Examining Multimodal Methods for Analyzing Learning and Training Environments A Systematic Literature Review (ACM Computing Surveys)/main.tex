...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.3\textwidth]{img/statistical_imgs/publications_w_o_others.png}
        \caption{Large Image}
    \end{subfigure}
